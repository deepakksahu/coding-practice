# https://twitter.com/GnothiSea/status/1322875609559769088?s=20
...
FONT_USER_INFO = ImageFont.truetype("/Users/deepak.sahu/venv/lib/python3.7/site-packages/reportlab/fonts/Adriana.ttf", 90, encoding="utf-8")
FONT_TEXT = ImageFont.truetype("/Users/deepak.sahu/venv/lib/python3.7/site-packages/reportlab/fonts/Adriana.ttf", 110, encoding="utf-8")
...
# -----------------------------------------------------------------------------
user_name = "Temet Nosce"
user_tag = "@GnothiSea"
text = "If you don't become the ocean,you'll be seasick every day.\n" \
       "-Leonard Cohen"
...
user_photo = Image.open('user_photo.png', 'r').convert("RGBA")
